...
const InstagramFeed: React.FC<InstagramFeedProps> = ({ 
  ...
  const mockPosts: InstagramPost[] = [
    {
      id: '1',
      media_url: '/bridal-showers/LandingPage.jpg',
      media_type: 'IMAGE',
    ...
    {
      id: '2',
      media_url: '/Corporate/20210721_155342.jpg',
      media_type: 'IMAGE',
    ...
    {
      id: '3',
      media_url: '/baby-showers/IMG_0796.JPEG',
      media_type: 'IMAGE',
    ...
    {
      id: '4',
      media_url: '/Birthdays/IMG_2972.jpg',
      media_type: 'IMAGE',
    ...
    {
      id: '5',
      media_url: '/Holidays/339661EC-7B8C-4F55-BD25-280CF2E61A29.jpg',
      media_type: 'IMAGE',
    ...
    {
      id: '6',
      media_url: '/Birthdays/IMG_2705.JPG',
      media_type: 'IMAGE',
    ...
    {
      id: '7',
      media_url: '/Corporate/20210816_183032.jpg',
      media_type: 'IMAGE',
    ...
    {
      id: '8',
      media_url: '/Birthdays/IMG_2939.JPG',
      media_type: 'IMAGE',
